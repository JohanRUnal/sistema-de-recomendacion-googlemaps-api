...
###  Obtención y  preparación de los datos:
 Los datos son obtenidos atraves API dada de GoogleMaps y haremos un *preprocesamiento* de los datos de manera que esten listos para que sean consumidos por nuestro sistema de recomendación.
